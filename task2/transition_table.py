...
def dormant_to_active(state, prob, index, flag = 1):
    return ( prob*0.2*(step_cost*flag + kill_monster_reward(state[3]) + gamma*( V[state[0]][state[1]][state[2]][state[3]][1][index-1]  )) + prob*0.8*( step_cost*flag + kill_monster_reward(state[3]) + gamma*( V[state[0]][state[1]][state[2]][state[3]][0][index-1] )) )

def active_to_dormant(init_pos, init_state ,state, prob, index, flag = 1):
    if(init_pos==4 or init_pos==2):
        return ( 0.5*prob*( step_cost*flag -40 + gamma*(  V[init_pos][0][init_state[2]][min(4,init_state[3] + 1)][0][index-1]  )  ) + 0.5*prob*( step_cost*flag + kill_monster_reward(state[3]) + gamma*(  V[state[0]][state[1]][state[2]][state[3]][state[4]][index-1]  )) )
    else:
        return ( 0.5*prob*( step_cost*flag + kill_monster_reward(state[3]) + gamma*(  V[state[0]][state[1]][state[2]][state[3]][0][index-1]  )  ) + 0.5*prob*( step_cost*flag + kill_monster_reward(state[3]) + gamma*(  V[state[0]][state[1]][state[2]][state[3]][state[4]][index-1]  )) )
        ...
        if(state[0] == 4):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (dormant_to_active([4,state[1],state[2],state[3],state[4]], 0.85, index , 0) + dormant_to_active([2,state[1],state[2],state[3],state[4]], 0.15, index , 0))
            ...
            if(action=='HIT_SWORD'):
                return (dormant_to_active([4,state[1],state[2],max(0,state[3]-2),state[4]], 0.1, index ) + dormant_to_active([4,state[1],state[2],state[3],state[4]], 0.9, index ))
        ...
        if(state[0]== 0):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (dormant_to_active([0,state[1],state[2],state[3],state[4]], 0.85, index , 0) + dormant_to_active([2,state[1],state[2],state[3],state[4]], 0.15, index , 0))
        ...
        if(state[0]==1):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (dormant_to_active([1,state[1],state[2],state[3],state[4]], 0.85, index , 0) + dormant_to_active([2,state[1],state[2],state[3],state[4]], 0.15, index , 0))
        ...
        if(state[0]==2):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (dormant_to_active([2,state[1],state[2],state[3],state[4]], 1, index , 0) )
            if(action=='SHOOT_ARROW'):
            ...
            if(action=='HIT_SWORD'):
                return (dormant_to_active([2,state[1],state[2],max(0,state[3]-2),state[4]], 0.2, index ) + dormant_to_active([2,state[1],state[2],state[3],state[4]], 0.8, index ))
        ...
        if(state[0]==3):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (dormant_to_active([3,state[1],state[2],state[3],state[4]], 1, index , 0) )
            if(action=='SHOOT_ARROW'):
    ...
    # =============================================================================================================================now active to dormant =============================================================================================================================
        ...
        if(state[0] == 4):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (active_to_dormant(4, state,[4,state[1],state[2],state[3],state[4]], 0.85, index , 0) + active_to_dormant(4, state,[2,state[1],state[2],state[3],state[4]], 0.15, index , 0))
            if(action=='SHOOT_ARROW'):
            ...
            if(action=='HIT_SWORD'):
                return (active_to_dormant(4, state,[4,state[1],state[2],max(0,state[3]-2),state[4]], 0.1, index ) + active_to_dormant(4, state,[4,state[1],state[2],state[3],state[4]], 0.9, index ))
        ...
        if(state[0]== 0):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (active_to_dormant(0, state,[0,state[1],state[2],state[3],state[4]], 0.85, index , 0) + active_to_dormant(0, state,[2,state[1],state[2],state[3],state[4]], 0.15, index , 0))
            if(action=='CRAFT_ARROWS'):
        ...
        if(state[0]==1):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (active_to_dormant(1, state,[1,state[1],state[2],state[3],state[4]], 0.85, index , 0) + active_to_dormant(1, state,[2,state[1],state[2],state[3],state[4]], 0.15, index , 0))
            if(action=='GATHER_MATERIALS'):
        ...
        if(state[0]==2):
            if(action=='LEFT'):
                ...
                # case 2 E->W
                # return (active_to_dormant(2, state,[3,state[1],state[2],state[3],state[4]], 1, index ) )
            if(action=='STAY'):
                if(flag_stay_zero):
                    return (active_to_dormant(2, state,[2,state[1],state[2],state[3],state[4]], 1, index ) )
                else:
                    return (active_to_dormant(2, state,[2,state[1],state[2],state[3],state[4]], 1, index , 0) )
            if(action=='SHOOT_ARROW'):
            ...
            if(action=='HIT_SWORD'):
                return (active_to_dormant(2, state,[2,state[1],state[2],max(0,state[3]-2),state[4]], 0.2, index ) + active_to_dormant(2, state,[2,state[1],state[2],state[3],state[4]], 0.8, index ))
        ...
        if(state[0]==3):
            ...
            if(action=='STAY'):
                if(flag_stay_zero):
                    ...
                    return (active_to_dormant(3,state,[3,state[1],state[2],state[3],state[4]], 1, index , 0) )
            if(action=='SHOOT_ARROW'):
